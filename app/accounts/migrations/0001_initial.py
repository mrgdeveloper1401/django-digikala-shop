    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', django_jalali.db.models.jDateTimeField(blank=True, default=datetime.datetime(2023, 11, 14, 20, 51, 31, 24284, tzinfo=datetime.timezone.utc), null=True, verbose_name='تاریخ اخرین ورود')),
