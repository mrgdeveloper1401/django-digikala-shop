    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', django_jalali.db.models.jDateTimeField(blank=True, default=datetime.datetime(2023, 11, 22, 6, 1, 59, 561185, tzinfo=datetime.timezone.utc), null=True, verbose_name='تاریخ اخرین ورود')),
