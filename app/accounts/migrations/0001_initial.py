    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', django_jalali.db.models.jDateTimeField(blank=True, default=datetime.datetime(2023, 12, 3, 3, 52, 30, 168549, tzinfo=datetime.timezone.utc), null=True)),
