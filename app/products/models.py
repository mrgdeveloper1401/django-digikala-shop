...
class ProductModel(CreateModel):
    ...
    product_auth_code = models.CharField(_('کد شناسایی هر کالا'), max_length=128, unique=True)    saller = models.OneToOneField('SallerModel', on_delete=models.PROTECT, related_name='sallers')
