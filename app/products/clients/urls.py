...
from .views import ProductAttributeModelViewSet \
    ,ProductLineModelViewSet, ProductModelViewSet, BrandViewSet, ProductAttributeValueModelViewSet 
from rest_framework.routers import DefaultRouter

router = DefaultRouter()
router.register(r'product_attribute', ProductAttributeModelViewSet, basename='product_attribute')
router.register(r'product_attribute_value', ProductAttributeValueModelViewSet, basename='product_attribute_value')
