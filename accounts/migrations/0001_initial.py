    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', django_jalali.db.models.jDateTimeField(blank=True, default=datetime.datetime(2023, 11, 10, 16, 4, 22, 36826, tzinfo=datetime.timezone.utc), null=True, verbose_name='date joined')),
