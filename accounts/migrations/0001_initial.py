    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', django_jalali.db.models.jDateTimeField(blank=True, default=datetime.datetime(2023, 11, 11, 14, 24, 36, 807104, tzinfo=datetime.timezone.utc), null=True, verbose_name='date joined')),
